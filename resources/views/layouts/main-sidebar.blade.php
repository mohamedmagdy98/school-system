        ...
        <div class="side-menu-fixed">
            <div class="scrollbar side-menu-bg">
                <ul class="nav navbar-nav side-menu" id="sidebarnav">
                    <!-- menu item Dashboard-->
                    <!-- menu title -->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">{{__('layout.menu')}} </li>
                    <!-- menu item Elements-->
                    <li>
                        <a href="{{route('home')}}" >
                            <div class="pull-left"><i class="ti-home"></i><span class="right-nav-text">{{__('layout.home')}}</span>
                            </div>
                            <div class="pull-right"><i class="ti-right"></i></div>
                            <div class="clearfix"></div>
                        </a>

                    </li>
                    <!-- menu title -->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">{{__('layout.main_data')}} </li>
                    <!-- menu item Elements-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#stages">
                            <div class="pull-left"><i class="ti-harddrives"></i><span
                                    class="right-nav-text">{{__('layout.stages')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="stages" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('stages.index')}}">{{__('layout.stages_list')}}</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#grades-menu">
                            <div class="pull-left"><i class="ti-menu-alt"></i><span
                                    class="right-nav-text">{{__('layout.grades')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="grades-menu" class="collapse" data-parent="#sidebarnav">
                            <li><a href="{{route('grades.index')}}">{{__('layout.grades_list')}}</a></li>
                    ...
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#classrooms-menu">
                            <div class="pull-left"><i class="ti-blackboard"></i><span
                                    class="right-nav-text">{{__('layout.classes')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="classrooms-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('classrooms.index')}}">{{__('layout.classes_list')}} </a> </li>

                        </ul>
                    </li>
                    <!-- menu section hr-->
                    <li class="mt-10 mb-10 text-muted pl-4 font-medium menu-title">{{__('layout.hr_data')}} </li>

                    <!-- menu item parents-->
                    <li>
                        <a href="javascript:void(0);" data-toggle="collapse" data-target="#parents-menu">
                            <div class="pull-left"><i class="fas fa-users"></i><span
                                    class="right-nav-text">{{__('layout.parents')}}</span></div>
                            <div class="pull-right"><i class="ti-plus"></i></div>
                            <div class="clearfix"></div>
                        </a>
                        <ul id="parents-menu" class="collapse" data-parent="#sidebarnav">
                            <li> <a href="{{route('parents.index')}}">{{__('layout.parents_list')}} </a> </li>
